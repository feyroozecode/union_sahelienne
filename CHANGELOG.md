...
### Why
- No modern, public, production-ready frontend existed — every branch only carried the simple 2-color admin dashboard (confirmed by scanning all 28 remote branches). Merging `backend`→`main` was rejected as it would only re-import 54k build artifacts + conflict markers.
